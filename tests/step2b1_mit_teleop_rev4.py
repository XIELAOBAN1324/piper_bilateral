...
"""
Piper Phase 2B-1 MIT Teleoperation rev4
...
---
Dry run:
    python tests/step2b1_mit_teleop_rev4.py

Live 30 s diagnostic:
    python tests/step2b1_mit_teleop_rev4.py --live --record --duration 30

A/B velocity feed-forward:
    python tests/step2b1_mit_teleop_rev4.py --live --record --duration 30 --vel-scale 0
    python tests/step2b1_mit_teleop_rev4.py --live --record --duration 30 --vel-scale 0.12
...
def main():
    ...
    try:
        print("=" * 78)
        print("Piper Phase 2B-1 MIT Teleoperation (rev4)")
        print("=" * 78)
        ...
        print("[6] Phase 2B-1 rev4 loop started")
